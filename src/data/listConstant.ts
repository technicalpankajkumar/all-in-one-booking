export const WORLD_CAR_TYPES = [
  ...
  { label: "Backhoe Loader", value: "BACKHOE" },
  { label: "Excavator", value: "EXCAVATOR" },
  { label: "Bulldozer", value: "BULLDOZER" },

  // 🔋 Electric & Alternate Energy
  { label: "Electric Car (EV)", value: "EV" },
  { label: "Hybrid Car", value: "HYBRID" },
  { label: "Plug-in Hybrid (PHEV)", value: "PHEV" },
  { label: "Hydrogen Fuel Cell Vehicle", value: "FCEV" },
